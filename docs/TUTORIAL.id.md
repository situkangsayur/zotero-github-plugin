...
## 7. Sinkron dari lebih dari satu komputer

Plugin mengingat apa yang terakhir disinkronkan dari tiap komputer, sehingga bisa membedakan
perubahan Anda dari perubahan di GitHub atau komputer lain. Kalau sinkronisasi menemukan
sesuatu yang perlu diputuskan, panel tinjauan terbuka di dalam jendela Zotero:

![Panel review](images/review-panel.png)

| Bagian | Artinya | Pilihan Anda |
| --- | --- | --- |
| **Changes on GitHub** | Diubah atau ditambah di tempat lain, tidak berubah di sini | Centang untuk mengimpor ke Zotero; yang tidak dicentang ditanyakan lagi lain kali |
| **Changed in both places** | Diubah di sini *dan* di tempat lain | Simpan versi Zotero, ambil versi GitHub, atau — untuk berkas — simpan keduanya |
| **Deleted on GitHub, still in Zotero** | Komputer lain menghapusnya | Centang untuk mengunggah lagi. Untuk menerima penghapusan, hapus item itu di Zotero |
| **Edited on GitHub, generated by the plugin** | Seseorang mengedit catatan Markdown atau indeks di GitHub | Berkas ini dibuat ulang dari pustaka; hilangkan centang untuk membiarkannya kali ini |
| **Files this sync replaces or deletes on GitHub** | Perubahan Anda sendiri | Hilangkan centang untuk mengecualikan berkas dari sinkron ini |

Klik **Sync** untuk menerapkan pilihan, atau **Cancel** (atau tekan Escape) agar tidak ada yang
berubah.

Sinkron latar belakang tidak pernah menunggu Anda. Ia hanya mengunggah yang aman dan
membiarkan sisanya; tombol menampilkan titik oranye:

![Tombol toolbar dengan perubahan yang menunggu ditinjau](images/toolbar-attention.png)

Klik tombol itu, atau gunakan **Tools → GitHub Sync → Review Changes and Sync…**. Menu itu juga
menampilkan tinjauan ketika tidak ada yang perlu diputuskan, sehingga Anda bisa melihat — dan
mengecualikan — berkas mana yang akan diganti atau dihapus di GitHub.

## 8. Memulihkan di komputer lain
...
- **Zotero tetap sumber kebenaran.** Perubahan di GitHub baru masuk ke pustaka kalau Anda
  menerimanya di panel review, dan sinkronisasi tidak pernah menghapus apa pun dari pustaka.
